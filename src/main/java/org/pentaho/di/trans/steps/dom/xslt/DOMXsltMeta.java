 ...
 *
 */
@Step(id = "DOMXSLT", image = "ui/images/XSLT.svg", name = "DOM XSLT Transformation", description = "i18n:org.pentaho.di.trans.step:BaseStep.TypeLongDesc.XSLT", categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.Transform")
public class DOMXsltMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public Object clone() {
    DOMXsltMeta retval = (DOMXsltMeta) super.clone();
  ...
  private void readData( Node stepnode ) throws KettleXMLException {
    try {
      ...
      throw new KettleXMLException(
        BaseMessages.getString( PKG, "XsltMeta.Exception.UnableToLoadStepInfoFromXML" ), e );
    }
  }
  ...
  public void readRep( Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases ) throws KettleException {
    try {
      ...
      throw new KettleException( BaseMessages.getString(
        PKG, "XsltMeta.Exception.UnexpectedErrorInReadingStepInfo" ), e );
    }
  }
  ...
  public void saveRep( Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step ) throws KettleException {
    try {
      ...
      throw new KettleException( BaseMessages.getString( PKG, "XsltMeta.Exception.UnableToSaveStepInfo" )
        + id_step, e );
    }
  }
