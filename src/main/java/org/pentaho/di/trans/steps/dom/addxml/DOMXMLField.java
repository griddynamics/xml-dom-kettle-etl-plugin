 ...
 *
 */
public class DOMXMLField implements Cloneable {
  ...
  public DOMXMLField( String fieldName, String elementName, int type, String format, int length, int precision,
  ...
  public int compare( Object obj ) {
    DOMXMLField field = (DOMXMLField) obj;
