 ...
 *
 */
@Step(id = "AddDOMXML", image = "ui/images/add_xml.svg", name = "Add DOM XML", description = "i18n:org.pentaho.di.trans.step:BaseStep.TypeLongDesc.AddXML", categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.Transform")
public class AddDOMXMLMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  /** The output fields */
  private DOMXMLField[] outputFields;

  public AddDOMXMLMeta() {
   ...
   */
  public DOMXMLField[] getOutputFields() {
    return outputFields;
  }
   ...
   */
  public void setOutputFields( DOMXMLField[] outputFields ) {
  ...
  public void allocate( int nrfields ) {
    outputFields = new DOMXMLField[nrfields];
  }

  public Object clone() {
    AddDOMXMLMeta retval = (AddDOMXMLMeta) super.clone();
    int nrfields = outputFields.length;

    retval.allocate( nrfields );

    for ( int i = 0; i < nrfields; i++ ) {
      retval.outputFields[i] = (DOMXMLField) outputFields[i].clone();
    }
  ...
  private void readData( Node stepnode ) throws KettleXMLException {
    try {
      ...
      for ( int i = 0; i < nrfields; i++ ) {
        ...
        outputFields[i] = new DOMXMLField();
  ...
  public String getXML() {
    ...
    for ( int i = 0; i < outputFields.length; i++ ) {
      DOMXMLField field = outputFields[i];
